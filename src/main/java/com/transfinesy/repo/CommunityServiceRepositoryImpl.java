...
/**
 * JDBC implementation of CommunityServiceRepository.
 */
public class CommunityServiceRepositoryImpl implements CommunityServiceRepository {
    ...
    public List<CommunityService> findAll() {
        ...
        try (Connection conn = DBConfig.getConnection();
            ...
            while (rs.next()) {
                ...
                // Handle description field (may be null for existing records or if column doesn't exist)
            ...
            e.printStackTrace();
            // Return empty list - don't crash the application
        }
    ...
    public void save(CommunityService cs) {
        // Try with description first, fallback to without if column doesn't exist
